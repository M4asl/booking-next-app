...
const MyBookings = () => {
  ...
  const downloadInvoice = async (booking) => {
    const data = {
      ...
      marginLeft: 25,
      marginBottom: 25,
      logo: 'https://res.cloudinary.com/dh4xmgifo/image/upload/v1663437340/bookingApp/avatars/BookLogo_qvnxjs.png',
      sender: {
        company: 'BookingApp',
      ...
      bottomNotice:
        'This is auto generated Invoice of your booking on BookingApp.',
    };
